...
import com.cnoke.net.interception.LogInterceptor.Companion.isJson
import com.cnoke.net.interception.LogInterceptor.Companion.isXml
import com.cnoke.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.cnoke.net.interception.logging.util.CharacterHandler.Companion.xmlFormat
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    companion object {
        ...
        private fun isEmpty(line: String): Boolean {
            return line.isNullOrBlank() || N == line || T == line
                    || line.trim { it <= ' ' }.isNullOrBlank()
        }
        ...
        private fun getResponse(
            ...
            log =
                ((if (!segmentString.isNullOrBlank()) "$segmentString - " else "") + "is success : "
