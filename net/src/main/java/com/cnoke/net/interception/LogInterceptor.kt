...
import com.cnoke.net.interception.logging.util.CharacterHandler.Companion.jsonFormat
import com.cnoke.net.interception.logging.util.LogUtils
import com.cnoke.net.interception.logging.util.UrlEncoderUtils.Companion.hasUrlEncoded
import com.cnoke.net.interception.logging.util.ZipHelper.Companion.decompressForGzip
import com.cnoke.net.interception.logging.util.ZipHelper.Companion.decompressToStringForZlib
import okhttp3.*
import okio.Buffer
...
class LogInterceptor(
    isDebug : Boolean = true, private val printLevel: Level?  =
    Level.ALL) : Interceptor {

    private val mPrinter: FormatPrinter = DefaultFormatPrinter()

    init {
        LogUtils.setLog(isDebug)
    }
